...
prime_checker.py → Prime number checking using functions
factorial_function.py → Factorial calculation using loops
fibonacci_function.py → Fibonacci sequence (iterative and recursive)
string_functions.py → String operations (reverse, palindrome, vowel counting)
Goal
